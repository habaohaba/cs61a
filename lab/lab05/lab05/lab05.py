...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    output = sqrt( (get_lat(city_a) - get_lat(city_b))**2 + (get_lon(city_a) - get_lon(city_b))**2)
    return output
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    desti = make_city('desti_name', lat, lon)
    if distance(desti, city_a) < distance(desti, city_b):
